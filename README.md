...
Proses insert bangunan dapat dilakukan dengan mengklik floating button di halaman Bangunan
...
Proses Edit atau Update dapat dilakukan dengan mengklik icon edit di halaman homepage bangunan atau klik floating button di detail bangunan
...
Proses Delete dapat dilakukan dengan mengklik icon sampah di halaman homepage bangunan
...
Proses insert kamar dapat dilakukan dengan mengklik floating button di halaman Bangunan
...
Proses Edit atau Update dapat dilakukan dengan mengklik icon edit di halaman homepage Kamar atau klik floating button di detail Kamar
...
Proses Delete dapat dilakukan dengan mengklik icon sampah di halaman homepage kamar
...
### Operasi Insert pada Mahasiswa
Proses insert Mahasiswa dapat dilakukan dengan mengklik floating button di halaman Mahasiswa
...
Proses Edit atau Update dapat dilakukan dengan mengklik icon edit di halaman homepage Mahasiswa atau klik floating button di detail Mahasiswa
...
### Proses Tambah Pembayaran pada Button Tambah Pembayaran di detail Mahasiswa
Proses Tambah Pembayaran dapat dilakukan dengan mengklik button Tambah Pembayaran, dan untuk lihat hasil pembayaran dengan mengklik Button lihat riwayat transaksi pada halaman Detail Mahasiswa
...
### Operasi Delete pada Mahasiswa
Proses Delete dapat dilakukan dengan mengklik icon sampah di halaman homepage Mahasiswa
